...
class Pessoa:
    ...
    def __post_init__(self):
        if not isinstance(self.nome, str):
            raise TypeError(f'Invalid type {type(self.nome).__name__} != em {self}')
...
p1 = Pessoa('Italo', 'Fernandes')
p2 = Pessoa('Giovanna', 'Martins')
p3 = Pessoa('Hermelindo', 'Calazensio')
p4 = Pessoa('Violeta', 'Calazans')
