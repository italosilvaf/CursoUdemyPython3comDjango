...
def funcao(parametro_lista):

    lista_auxiliar = []

    for numero in parametro_lista:

        if numero not in lista_auxiliar:
            lista_auxiliar.append(numero)

            if lista_auxiliar == parametro_lista:
                retorno = -1
                return f'{parametro_lista} {retorno}'

        else:
            return f'{parametro_lista} {numero}'


for cada_lista in lista_de_listas_de_inteiros:
    print(funcao(cada_lista))
...
for cada_lista_confirmacao in lista_confirmacao:
    print(funcao(cada_lista_confirmacao))
