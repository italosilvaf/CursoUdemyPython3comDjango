...
def main(main_images_folder, new_width=800):
    ...
    for root, dirs, files in os.walk(main_images_folder):
        for file in files:
            ...
            # if converted_tag in file_full_path:  # Isso é para remover as imagens convertidas.
...
if __name__ == '__main__':
    main_images_folder = r"C:\Users\Usuario\PycharmProjects\CusoPython - Secao 5\pillow_aula\images"
    main(main_images_folder, new_width=700)
