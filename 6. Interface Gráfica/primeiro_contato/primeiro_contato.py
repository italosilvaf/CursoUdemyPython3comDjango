...
class App(QMainWindow):
    def __init__(self, parent=None):
        ...
        self.btn.setStyleSheet('font-size: 40px;')  # mudando o tamanho da fonte do Texte do botão.
        self.grid.addWidget(self.btn, 0, 0, 1, 1)  # posicação do botão e o espaço que ele vai ocupar.

        self.setWindowTitle('Título da Janelinha')
